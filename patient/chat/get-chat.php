<?php 
    ...
    if(isset($_SESSION['p_id'])){
        ...
        $incoming_id = $_SESSION['p_id'];
        $outgoing_id  = $mycon->real_escape_string($_POST['incoming_id']);
        $output = "";
        // $sql = "SELECT * FROM chat LEFT JOIN healthworkertb ON healthworkertb.hw_id = chat.outgoing_msg_id";
   $sql = "SELECT * FROM chat LEFT JOIN patient ON patient.p_phone = chat.outgoing_msg_id
