                        ...
                        <form action="#" method="POST" class="text-left form-signin needs-validation" novalidate="" name="logform" id="logform">
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="emailusername" name="emailusername" type="text" class="form-control" placeholder="e.g John_Doe">
                                </div>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" id="submitlog" class="btn btn-primary" value="">Log In</button>
                                    </div>
                                </div>
